...
class ValidateUtilsTest {
    ...
    void validNormal() {
        // given
        final String source = DEFAULT_SOURCE.substring(0, ConstantUtils.CAR_NAME_MAX_LENGTH);

        assertThatCode(() -> ValidateUtils.maxLength(source, ConstantUtils.CAR_NAME_MAX_LENGTH))
    ...
    void validNull(final String source) {
        assertThatThrownBy(() -> ValidateUtils.maxLength(source, ConstantUtils.CAR_NAME_MAX_LENGTH))
    ...
    void validLong() {
        // given
        final String source = DEFAULT_SOURCE.substring(0, ConstantUtils.CAR_NAME_MAX_LENGTH + 1);
